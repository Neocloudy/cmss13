...
/obj/item/storage/box/kit/command/corpsman/m41a
	...
	desc = "A large case containing an advanced corpsman loadout for Staff Officers to use during deployment.\n\nContains a corpsman loadout with 3 advanced first aid kits, 3 defibrillators, a full lifesaver belt, a M41A MK2 rifle and plenty of ammunition to carry on your armor and webbing.\nTo take the webbing out of it, drop it on the floor. Drag this sprite onto yourself to open it up! NOTE: You cannot put items back inside this case."
...
/obj/item/storage/box/kit/command/rifleman
	name = "\improper Standard equipment case (M39)"
	desc = "A large case containing a standard loadout to be vended from armories.\n\nContains light armor and a M39 SMG with plenty of ammunition to carry on your armor and webbing.\nTo take the webbing out of it, drop it on the floor. Drag this sprite onto yourself to open it up! NOTE: You cannot put items back inside this case."

/obj/item/storage/box/kit/command/rifleman/fill_preset_inventory()
	new /obj/item/clothing/glasses/hud/health(src)
	new /obj/item/clothing/head/helmet/marine(src)
	new /obj/item/clothing/shoes/marine/knife(src)
...
/obj/item/storage/box/kit/command/rifleman/strict/fill_preset_inventory() // Strict variant that uses Officer armor and won't give you some other things like a HUD.
	new /obj/item/clothing/head/helmet/marine(src)
	new /obj/item/clothing/shoes/marine/knife(src)
	new /obj/item/storage/backpack/marine(src)
...
/obj/item/storage/box/kit/command/rifleman/m41a
	name = "\improper Standard equipment case (M41A)"
	desc = "A large case containing a standard loadout to be vended from armories.\n\nContains armor and a M41A MK2 rifle with plenty of ammunition to carry on your armor and webbing.\nTo take the webbing out of it, drop it on the floor. Drag this sprite onto yourself to open it up! NOTE: You cannot put items back inside this case."

/obj/item/storage/box/kit/command/rifleman/m41a/fill_preset_inventory()
	new /obj/item/clothing/glasses/hud/health(src)
	new /obj/item/clothing/head/helmet/marine(src)
	new /obj/item/clothing/shoes/marine/knife(src)
	new /obj/item/storage/backpack/marine(src)
...
/obj/item/storage/box/kit/command/rifleman/m41a/strict/fill_preset_inventory() // Strict variant that uses Officer armor and won't give you some other things like a HUD or attachments. For armory.
	new /obj/item/clothing/head/helmet/marine(src)
	new /obj/item/clothing/shoes/marine/knife(src)
	new /obj/item/storage/backpack/marine(src)
	new /obj/item/clothing/suit/storage/marine/MP/SO(src)
